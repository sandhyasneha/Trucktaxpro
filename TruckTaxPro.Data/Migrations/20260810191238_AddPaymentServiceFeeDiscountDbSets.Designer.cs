...
namespace TruckTaxPro.Data.Migrations
{
    ...
    [Migration("20260810191238_AddPaymentServiceFeeDiscountDbSets")]
    partial class AddPaymentServiceFeeDiscountDbSets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TruckTaxPro.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TruckTaxPro.Domain.Announcement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TruckTaxPro.Domain.BlogPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TruckTaxPro.Domain.Business", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TruckTaxPro.Domain.BusinessTaxPeriod", b =>
                {
                    ...
                    b.Property<bool>("ConsentToDisclosure")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("TaxYearEnd")
                        .HasColumnType("int");

                    b.Property<int>("TaxYearStart")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TruckTaxPro.Data.ApplicationUser", null)
                        .WithMany()
